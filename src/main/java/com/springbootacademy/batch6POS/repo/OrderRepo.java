...
public interface OrderRepo extends JpaRepository<Order,Integer> {
    ...
    @Query(value = "select c.customer_name, customerName , c.customer_address as customerAddress,"+
            " c.contact_numbers as contactNumber,o.order_date as date , o.total as total from customer c,orders o where o.active_state = ?1"+
